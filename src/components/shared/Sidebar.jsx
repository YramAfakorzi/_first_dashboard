...
function Sidebar() {
  return (
    <div className='bg-neutral-900 text-white flex flex-col w-60 p-3'>
        <div className='flex gap-2 items-center px-1 py-3'>
            <FcBullish fontSize={24}/>
            <span className='text-neutral-100 text-lg'>OpenShop</span>
        </div>
        <div className='flex-1 py-8 flex flex-col gap-0.5'>{DASHBOARD_SIDEBAR_LINKS.map((item)=> <SidebarLink key={item.key} item={item}/>)}</div>
